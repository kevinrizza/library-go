...
replace github.com/openshift/api v0.0.0-20250320115527-3aa9dd5b9002 => github.com/kevinrizza/api-1 v1.33.0

replace github.com/openshift/client-go v0.0.0-20250125113824-8e1f0b8fa9a7 => github.com/kevinrizza/client-go v1.33.0
